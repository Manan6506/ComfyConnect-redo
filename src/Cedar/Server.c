...
void SiLoadInitialConfiguration(SERVER *s)
{
	...
	{
		// ComfyConnect: keep-alive phone-home disabled by default (was pinging an
		// external host every 50s). Admins can enable it with their own host if needed.
		k.UseKeepConnect = false;
	}
