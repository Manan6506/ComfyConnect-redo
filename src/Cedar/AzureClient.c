...
AZURE_CLIENT *NewAzureClient(CEDAR *cedar, SERVER *server)
{
	...
	// ComfyConnect: SoftEther-hosted VPN Azure relay is disabled. Returning NULL keeps
	// AzureClient absent -- b_support_azure reports false so the feature is hidden. No phone-home.
	return NULL;
