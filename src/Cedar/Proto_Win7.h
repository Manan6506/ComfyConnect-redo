...
#define	IPSEC_WIN7_DRIVER_TITLE			L"ComfyConnect VPN IPsec WFP Callout Driver"
#define	IPSEC_WIN7_DRIVER_TITLE_V4		L"ComfyConnect VPN IPsec WFP Callout for IPv4"
#define	IPSEC_WIN7_DRIVER_TITLE_V6		L"ComfyConnect VPN IPsec WFP Callout for IPv6"
